...
import { useContractList, useDeleteContract } from '../hooks/useContract';
...
const STATUSES = ['DRAFT', 'ACTIVE', 'EXPIRING', 'EXPIRED', 'ENDED', 'RENEWED', 'TERMINATED', 'LIQUIDATED'] as const;
...
export default function ContractListPage() {
  ...
  const handleDelete = (contract: BilContractResponse) => {
    if (!window.confirm(t('billing:contract.deleteConfirm'))) return;
