...
export default function ClientForgotPasswordPage() {
  ...
  const onSubmit = async (data: FormValues) => {
    if (!selectedEntity) {
      setError(t('auth:entityCodeRequired'));
      return;
    }
    try {
      setError(null);
              ...
              <div>
                ...
                {selectedEntity ? (
                  ...
                  <button
                    ...
                    className="flex w-full items-center gap-2 rounded-lg border border-gray-300 px-3 py-2 text-sm text-gray-400 transition-colors hover:border-indigo-400 hover:text-gray-600"
                  >
